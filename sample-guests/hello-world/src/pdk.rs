...
mod exports {
    ...
    #[no_mangle]
    pub extern "C" fn gossipMessageHandler() -> i32 {
        let ret = crate::gossip_message_handler(try_input_json!()).and_then(extism_pdk::output);
    ...
    pub extern "C" fn init() -> i32 {
        let ret = crate::init().and_then(extism_pdk::output);
    ...
    pub extern "C" fn shutdown() -> i32 {
        let ret = crate::shutdown().and_then(extism_pdk::output);
    ...
    pub extern "C" fn tick() -> i32 {
        let ret = crate::tick().and_then(extism_pdk::output);
...
pub mod types {
    ...
    pub struct InboundGossipMsg {
        /// The JSON content received from a peer
    ...
    pub struct OutboundGossipMsg {
        /// The JSON content to broadcast to peers
        #[serde(rename = "content")]
        pub content: serde_json::Map<String, serde_json::Value>,
    }
...
mod raw_imports {
    ...
    extern "ExtismHost" {
        ...
        pub(crate) fn broadcast_msg(input: Json<types::OutboundGossipMsg>) -> bool;

        pub(crate) fn guest_error(input: String);

        pub(crate) fn guest_info(input: String);

        pub(crate) fn guest_warn(input: String);
...
/// broadcast_msg Broadcast a message to all peers in the gossip network
/// It takes input of types::OutboundGossipMsg ()
/// And it returns an output bool (No return value - operation success indicated by lack of error)
#[allow(unused)]
pub(crate) fn broadcast_msg(
    input: types::OutboundGossipMsg,
) -> std::result::Result<bool, extism_pdk::Error> {
    let res = unsafe { raw_imports::broadcast_msg(extism_pdk::Json(input))? };

    Ok(res)
}

/// guest_error Log an error message to the host logger
/// It takes input of String (The message to log at ERROR level)
#[allow(unused)]
pub(crate) fn guest_error(input: String) -> std::result::Result<(), extism_pdk::Error> {
    let res = unsafe { raw_imports::guest_error(input)? };

    Ok(res)
}

/// guest_info Log an informational message to the host logger
/// It takes input of String (The message to log at INFO level)
#[allow(unused)]
pub(crate) fn guest_info(input: String) -> std::result::Result<(), extism_pdk::Error> {
    let res = unsafe { raw_imports::guest_info(input)? };

    Ok(res)
}

/// guest_warn Log a warning message to the host logger
/// It takes input of String (The message to log at WARN level)
#[allow(unused)]
pub(crate) fn guest_warn(input: String) -> std::result::Result<(), extism_pdk::Error> {
    let res = unsafe { raw_imports::guest_warn(input)? };
